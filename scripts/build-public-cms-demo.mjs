...
for (const file of ["read-state.js", "storage.js"]) { const source = await readFile(join(output, "sandbox", file), "utf8"); await writeFile(join(output, "sandbox", file), source.replaceAll("../../../project-core/", "../project-core/")); }
